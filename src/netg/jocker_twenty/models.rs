...
pub struct UniqueBoardsInstanse {
    pub count: u64,
    pub frequency_average: u64,
    pub instanses: Vec<Board>,
}

#[derive(Clone, Debug, Serialize, Deserialize, Default, Eq, Hash, PartialEq)]
pub struct MultiplayedBoardsInstanse {
    pub instanses: Vec<Board>,
}

#[derive(Clone, Debug, Serialize, Deserialize, Default, Eq, Hash, PartialEq)]
pub struct BoardsInstanse {
    pub instanses: Vec<Vec<u8>>,
}
...
pub struct Boards {
    ...
    pub multiplied: Vec<MultiplayedBoardsInstanse>,
}

#[derive(Clone, Debug, Serialize, Deserialize, Default, Eq, Hash, PartialEq)]
pub struct ReelInstanse {
    pub reel: Vec<u8>,
    pub remaining: Vec<Board>,
    pub correct: bool,
}
